(() => {
  ...
  function openTicketModal(t) {
      ...
      function refreshQR() {
          const qrImg = document.getElementById("ticket-smart-qr");
          if (qrImg && currentTicket) {
              const ticket = (currentTicket.ticket_details && currentTicket.ticket_details.length > 0) 
                             ? currentTicket.ticket_details[0] 
                             : { id: 0, qr_hash: "none" };
              ...
              qrImg.src = `https://api.qrserver.com/v1/create-qr-code/?size=300x300&data=${encodeURIComponent(qrString)}&bgcolor=ffffff&color=000000&margin=10`;
