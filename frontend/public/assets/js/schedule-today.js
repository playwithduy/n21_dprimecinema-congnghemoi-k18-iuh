...
const API_CINEMAS = `${API_BASE}/api/showtimes/cinemas`;
const API_BY_DATE = (date) => `${API_BASE}/api/showtimes/by-date?date=${date}`;
const MOVIE_BASE  = window.location.protocol + "//" + window.location.hostname + ":3000";
